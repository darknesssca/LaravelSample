...
class ErrorRepository implements ErrorRepositoryContract
{
    public function getReportErrorByCode(int $code)
    {
        $errors = [
            ...
            1003 => 'Уважаемый Пользователь, проверьте корректность платежных данных (номер банковской карты) в Профайле',
            1010 => 'Произошла ошибка исполнения платежа, повотрите попытку позже'
        ];
